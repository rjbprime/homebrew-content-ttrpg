...
> ### Actions
> ***Smart Cast.*** The armor can cast any cantrips prepared by its operator, as the operator would. It can also cast *Magic Missile* at 3rd level 2 times/day.
>
> ***Protocol 3.*** The armor can use its model-specific offensive ability once, with any added ability score bonuses coming from the operator's scores. It can only attack once per Action.
>
> ***Proximity Alert. (Bonus Action)*** The armor has the ability to emit a shrill screeching noise that is audible to 100ft. This noise awakens sleeping creatures within 60ft of the armor.

```
```

>**Art Credit**: fbiuzz, *zerochan.net*


>***Note***: This is more akin to a subclass feature rather than a feat, but I left it as a feat for now to get some feedback on the idea before I attempt to tackle a subclass revison, should the need arise.


<img src='https://static.zerochan.net/Iron.Man.%28Character%29.full.2567022.png' style='position:absolute;bottom:50px;right:30px;width:320px' />

<div class='pageNumber auto'></div>
<div class='footnote'>PART 1 | ADDITIONAL FEATS</div>