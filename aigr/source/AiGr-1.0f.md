...
.phb#p2 h1, .phb#p3 h1, .phb#p4 h1 {
    font-size:16pt;
    margin-bottom:0mm;
}

.phb#p2 h3, .phb#p3 h3, .phb#p4 h3 {
  margin-top:-4 mm;
}

.phb:nth-child(n+2) h2 {
  font-size: 200%;
}

</style>

<div  class='wide' style="text-align:center;position:absolute;left:0mm;right:0mm;top:24mm;">

# Adventures in Gaia: Rebirth

</div>

<div class='wide' style="text-align:center;position:absolute;left:0mm;right:0mm;bottom:21.5mm;">
...
- ### [<span>1</span><span>Adventures in Gaia: Rebirth</span>](#p1)
- ### [<span>2</span><span>Table of Contents</span>](#p5)
- ### [<span>4</span><span>Chapter 1 &ndash; Table Guidelines</span>](#p6)
 - ####
    - [<span>4</span><span>Basic Etiquette</span>](#Basic-Etiquette)
    - [<span>4</span><span>It’s not personal</span>](#Not-Personal)
    - [<span>4</span><span>Quiet in the back</span>](#Quiet)
    - [<span>4</span><span>Be on time</span>](#On-Time)
    - [<span>4</span><span>Too far is too far</span>](#Too-Far)
    - [<span>4</span><span>You’re the hero! (but so are they&hellip;)</span>](#Heroes)
    - [<span>4</span><span>The Metagame</span>](#Metagame)
    - [<span>4</span><span>I’ve seen that before!</span>](#Seen-That)
    - [<span>4</span><span>Profanity is a Free Action!</span>](#Drat)
    - [<span>4</span><span>DM Fiat</span>](#DM-Fiat)
    - [<span>4</span><span>This is about fun</span>](#Have-Fun)
    - [<span>4</span><span>The Rule of Cool</span>](#RoC)
    - [<span>4</span><span>But my other DM&hellip;</span>](#But-But)
- ### [<span>5</span><span>Chapter 2 &ndash; Campaign House Rules</span>](#p5)
  - #### [<span>5</span><span>Campaign Sources in Use</span>](#Camp-Sources)
    - [<span>5</span><span>Non-WotC Campaign Sources In Use</span>](#Camp-Sources-In-Use)
    - [<span>5</span><span>Wizards of the Coast Player Options In Use</span>](#Camp-Sources-In-Use)
    - [<span>5</span><span>Exceptions</span>](#Camp-Source-Exception-Ref)
  - #### [<span>5</span><span>Character Creation at Campaign Start</span>](#Toon-Creation-at-Camp-Begin)
  - #### [<span>5</span><span>Character Rebuilding</span>](#Toon-Rebuilds)
  - #### [<span>5</span><span>Alignment</span>](#Alignent)
  - #### [<span>5</span><span>Feats and Humans</span>](#Feats-Vuman)
  - #### [<span>5</span><span>Changed Content from WotC Sources</span>](#WotC-Diffs)
    - [<span>5</span><span>Gift of the Ever-Living Ones</span>](#Gift-of-the-Ever-Living-Ones)
    - [<span>6</span><span>Revenant Blade</span>](#RevBlade)
  - #### [<span>6</span><span>HP</span>](#HP-Changes)
  - #### [<span>6</span><span>Gear Changes</span>](#Gear-Changes)
  - #### [<span>6</span><span>Learning New Tools, Languages </br>& Skills with Downtime</span>](#ew-Tools-Lang-Skills)
  - #### [<span>6</span><span>Variant: Skills with different abilities</span>](#Var-Skills)
  - #### [<span>6</span><span>Mark</span>](#DMG-Mark)
  - #### [<span>6</span><span>Other House Rules</span>](#Other-House-Rules)
  - #### [<span>6</span><span>Resting, Healing & Spell Recovery</span>](#Rest-Heal-Spell-Recovery)
  - #### [<span>6</span><span>Healing Spirit</span>](#Healing-Spirit)
  - #### [<span>6</span><span>Firearms in use and Changes</span>](#Firearms-Rules-Changes)
  - #### [<span>6</span><span>House Rules from other Sources</span>](#House-Rules-From-Other-RPGs)
    - [<span>6</span><span>13th Age RPG</span>](#13th-Age)
    - [<span>6</span><span>BA Morrier: Variant Rules</span>](#BA-Morrier-Var-Rules)
    - [<span>6</span><span>Tal'dorei Campaign Setting Rules</span>](#Crit-Role-Camp-Book-1)
    - [<span>7</span><span>Fifth Edition Options</span>](#Fith-Ed-Options)
- ### [<span>8</span><span>Chapter 3 &ndash; Core Races Changes</span>](#p9)
  - #### [<span>8</span><span>Dragonborn</span>](#pDragonborn)
    - [<span>8</span><span>Dragonborn Traits</span>](#Dragonborn-Traits)
    - [<span>8</span><span>Elemental Dragonborn</span>](#Elemental-Dragonborn)
    - [<span>8</span><span>Fearsome Dragonborn</span>](#Fear-Dragonborn)
    - [<span>8</span><span>Shadow Dragonborn</span>](#Shadow-Dragonborn)
  - #### [<span>8</span><span>Elves, and Half-elves</span>](#Elves-Half-Elves)
  - #### [<span>8</span><span>Humans</span>](#Humans)
    - [<span>8</span><span>Human, Dark</span>](#Shadow-Human)
  - #### [<span>8</span><span>Genasi</span>](#Genasi)
    - [<span>8</span><span>Air Genasi</span>](#Genasi-Air)
    - [<span>9</span><span>Earth Genasi</span>](#Genasi-Earth)
  - #### [<span>9</span><span>Gith</span>](#Gith)
    - [<span>9</span><span>Githzerai</span>](#Githzerai)
```
```

- 
  - 
  - #### [<span>9</span><span>Goliath</span>](#Goliath)
  - #### [<span>9</span><span>Kenku / Tengu</span>](#Kenku-Tengu)
  - #### [<span>9</span><span>Revenant</span>](#Revenant)
  - #### [<span>9</span><span>Tabaxi</span>](#Tabaxi)
  - #### [<span>9</span><span>Tiefling</span>](#Tiefling)
  - #### [<span>10</span><span>Warforged</span>](#Warforged)
    - [<span>10</span><span>Envoy Configuration</span>](#Warforged-Envoy)
    - [<span>10</span><span>Juggernaut Configuration</span>](#Warforged-Juggernaut)
    - [<span>10</span><span>Skirmisher Configuration</span>](#Warforged-Skirmisher)
    - [<span>10</span><span>Intergrated Protection and Roleplaying Tips</span>](#Warforged-AC-RP)
- ### [<span>11</span><span>Chapter 4 &ndash; New Races</span>](#p12)
  - #### [<span>11</span><span>Cait Sith</span>](#Cait-Sith)
    - [<span>11</span><span>Traits</span>](#Cait-Sith-Traits)
    - [<span>11</span><span>Sub-races</span>](#Cait-Sith-SubRaces)
  - #### [<span>11</span><span>Burmecian</span>](#Burmecian)
    - [<span>12</span><span>Traits</span>](#Burmecian-Traits)
    - [<span>12</span><span>Sub-races</span>](#Burmecian-SubRaces)
  - #### [<span>12</span><span>Mul</span>](#Mul)
    - [<span>12</span><span>Traits</span>](#Mul-Traits)
  - #### [<span>12</span><span>Selkies</span>](#Selkies)
    - [<span>12</span><span>Common Selkie Names</span>](#Selkies-Common-Names)
    - [<span>12</span><span>Traits</span>](#Selkies-Traits)
    - [<span>13</span><span>Sub-races</span>](#Selkies-SubRaces)
  - #### [<span>13</span><span>Vryloka</span>](#Vryloka)
    - [<span>13</span><span>Crimson Origins</span>](#Vryloka-Origins)
    - [<span>13</span><span>Alluring and Passionate</span>](#Vryloka-Allure)
    - [<span>13</span><span>A Life of Secrets</span>](#Vryloka-Secrets)
    - [<span>13</span><span>Common Vryloka Names</span>](#Vryloka-Common-Names)
    - [<span>13</span><span>Traits</span>](#Vryloka-Traits)
- ### [<span>14</span><span>Chapter 5 &ndash; Class Options \& Spells</span>](#p15)
  - #### [<span>14</span><span>Class Changes and Class Firearm Proficiencies</span>](#Class-Options-Ref-Table)
...
<div id="Fight-Styles-Unarmoured">
...
<img src='D:/RPGs/Personal/dmbinder/hb/source/imgs/Colossification.jpg' class='center' style='position:absolute;left:6mm;bottom:6mm;width:199mm;mix-blend-mode:multiply;' />

<div class='pageNumber auto'></div>

\page

# Chapter 6 &ndash; Equipment

<div class='classTable wide smallerRE' id="New-Gear-Ref-Table" style="margin-top:2mm;margin-bottom:0mm;">
...
|:--|--:|--:|:--:|:--:|--:|
| *Light Armor* | | | | | |
| &emsp;Mammoth Leathers | 45 gp | 14 + Dex | 13 | Disadvantage&dagger; | 30 lb. |
| *Medium Armor* | | | | | |
| &emsp;Plated Leather Armor | 200 gp | 13+Dex | &mdash; | Disadvantage | 20 lb. |
| &emsp;Leather Shoulder Guard | 10 gp | +1 (partial armor) | &mdash; | &mdash; | 1 lb. |
| *Heavy Armor* | | | | | |
| &emsp;Plate Shoulder Guard | 45 gp | +2 (partial armor) | &mdash; | &mdash; | 15 lb. |

## New Weapons

| **Name** | **Cost** | **Damage** | **Strength** | **Weight** | **Properties** |
|:--|--:|--:|--:|--:|--|
| *Simple Melee Weapons* | | | | | |
| &emsp;Scythe | 5 gp | 2d4 piercing</br>or slashing | &mdash; | 10 lb. | Finesse, High Crit, Two-Handed |
| &emsp;Tabaxi Battle Claw | 25 gp | 1d6 slashing | &mdash; | 1 lb. | Light, Finesse |
| *Simple Ranged Weapons* | | | | | |
| &emsp;Crossbow, Light Repeating  | 50 gp | 1d8 piercing | &mdash; | 6 lb. | Ammunition (range 80/320), reload (10), Two-Handed, Rogue |
| &emsp;Grenado | 2 gp | &mdash; | &mdash; | 2 lb. | Special |
| &emsp;Stinkpot | 1 gp | &mdash; | &mdash; | 2 lb. | Special |
| *Martial Melee Weapons* | | | | | |
| &emsp;Dwarven Mordenkrad | 30 gp | 2d6 bludgeoning</br>or piercing | &mdash; | 12 lb. | Heavy, Two-Handed, Brutal (1) |
| &emsp;Elven Curve Blade | 30 gp | 1d8 slashing | &mdash; | 2 lb. | Finesse, Versatile (1d10), Monk, Rogue |
| &emsp;Fullblade | 50 gp | 2d8 slashing | &mdash; | 10 lb. | Heavy, Two-Handed, High Crit |
| &emsp;Orcish Double-Axe | 40 gp | 2d6 slashing | &mdash; | 8 lb. | Double Weapon (1d6 slashing), Two-Handed |
| *Martial Ranged Weapons* | | | | | |
| &emsp;Crossbow, Heavy Repeating  | 100 gp | 1d10 piercing | &mdash; | 15 lb. | Ammunition (range 100/400), reload (10), Heavy, Two-Handed |
| &emsp;Elven Double Bow | 250 gp | 2d4 piercing | &mdash; | 3 lb. | Ammunition (range 150/600), Heavy, Two-Handed, High Crit |
| &emsp;Greatbow | 100 gp | 2d6 piercing | 15 | 6 lb. | Ammunition (range 250/1500), Heavy, Two-Handed, High Crit |
| *Buster-type Weapons* | | | | | | |
| &emsp;Buster Club | 1 gp | 2d8 bludgeoning | 17 | 30 lb. | Buster, two-handed |
| &emsp;Buster Sword | 200 gp | 3d6 slashing | 17 | 15 lb. | Buster, two-handed |
| &emsp;Greatmaul | 60 gp | 3d6 bludgeoning | 17 | 30 lb. | Buster, two-handed |
| &emsp;Ogre's Swallowblade | 150 gp | 2d8 slashing | 15 | 12 lb. | Special, Buster, Heavy, Two-Handed, Brutal (1) |
| &emsp;Oni Axe | 120 gp | 2d12 slashing | 17 | 21 lb. | Buster, two-handed |
| &emsp;Oni Glaive | 80 gp | 2d10 slashing | 17 | 18 lb. | Buster, reach, two-handed |
...
<div id="Arm-Desc-Prop">

## Armor Descriptions & Special Properties

</div>

<div id="Mammoth-leathers">

### Mammoth Leathers

</div>

Perfected by goliath shamans, this thick, exotic leather armor is made from mammoth hide. Because of the leather’s thickness, the armor is extremely confining for those who do not have the appropriate training. Wearing mammoth leather does not violate a druid’s spiritual oath.

&dagger;: Goliaths do not suffer disadvantage on Dexterity (Stealth) checks while wearing Mammoth Leathers, as they are trained in their use as a people.
...
Creatures smaller than Medium cannot use buster weapons whilst Medium creatures with a Strength score less than the shown Strength Score have disadvantage on attack rolls against them when wielding buster weapons.

A buster weapon's size and bulk makes it too large for a Medium creature to defend themselves effectively.
...
If you attack with a double weapon as part of the Attack action on your turn, you can use a bonus action immediately after to make a melee attack with it. This bonus attack deals the specified damage and type.
...
An oversized Greatclub, the Buster Club is a also known as an Ogre's Greatclub.
...
An oversized Greatsword, the Buster Sword is a also known as an Ogre's Greatsword.
...
A repeating crossbow does not need to be reloaded as long as it has ammunition in its magazine. A magazine costs 1 gp and holds 10 bolts. It takes an action to remove an empty magazine and load a new one.

<div id="Dwarf-Mordenkrad">
...
An oversized Maul, the Greatmaul is a also known as an Ogre's Maul.
...
Hollow ball of metal or clay fitted with a fuse and filled with black powder (gunpowder). As an action, you can light and throw a grenado at a point up to 30 feet away. Each creature within a 5-foot-radius of an exploding grenado must make a DC 12 Dexterity saving throw,  taking 2d4 fire damage on a failed save, or half as much damage on a successful one.

<div id="Ogre-Swallowblade">

### Ogre's Swallowblade

</div>

An *Ogre's Swallowblade* is an oversized *double-bladed scimitar*, and can be weilded as such. WHen combined with the *Revenant Blade* feat, you do not benefit from the *finesse* property.

Special. If you attack with a *ogre's swallowblade* as part of the Attack action on your turn, you can use a bonus action immediately after to make a melee attack with it. This attack deals 1d8 slashing damage on a hit, instead of 2d8.
...
An oversized Greataxe, the Oni Axe is a also known as an Ogre's Greataxe.
...
* **Dust.** A dust grenade that hits its target directly blinds the target for 1d4 rounds. A creature within the &ldqou;splash&rdqou; radius of the dust cloud (5 feet) must make a Constitution save (DC 10) or be blinded for 1 round. **Cost:** 10 gp.
...
* **Pepper.** A pepper grenade that hits its target directly incapacitates the target for 1 round unless it makes a successful Constitution save (DC 10). There is no &ldqou;splash&rdqou; effect. **Cost.** 10 gp.
...
Several windows allow those inside to see outside. The interior contains several fluorescent lights. The shelter can withstand winds of up to 120 mph, and provides excellent insulation for those inside, maintaining a temperature of about 70&#176; Fahrenheit. A small combination heater/air scrubber set on the floor near the entrance to the shelter controls the temperature and purifies any noxious external air into breathable air.
...
A 1st-level character licensed to an adventuring guild may purchase or start out with a basic field equipment pack for half price (20 gp). A character may only receive a beginner's discount on the same item once.

<div id="Journeyman-Field-Pack">
...
The journeyman field equipment pack costs 460 gp and weighs 59&frac12; pounds when fully stocked and includes the gear listed below.
...
* A strong, ultra-lightweight canvas for camouflage (Advantage on Stealth in natural areas when not moving) or protection against the weather (Advantage on any checks against weather hazards). 2 yards square. Can be put over the tent as a tarp to camouflage it and increase the cold and heat protection granted to occupants by 1 point. Value 10 gp; weight 1 lb.* A utility axe or machete, attached to the pack through a side loop. Base damage 1d6 (slashing). This item is a tool for gathering wood and cutting through thick brambles, and counts as an improvised weapon. Value 1 gp; weight 2 lb.
* A Tinderbox for making fires. Value 5 sp; weight 1 lb.
...
A sling is a strap which attaches to a two-handed ranged weapon (usually a crossbow or rifle) and is worn on the body, usually over a shoulder, making the weapon's weight easier to bear and keeping it close if it falls. When you drop a weapon attached to a sling you are wearing, it falls to your side and continues to hang within reach.
...
# Chapter 7 &ndash; New Feats

</div>

<div id="New-Feats-Non-Race">

## Non-Racial Feats

</div>

<div id="New-Feats-Buster-Master">
...
* You gain a +1 to either Strength or Constitution, to a maximum of 20.
...
* Before you make a melee attack with a buster weapon that you are proficient with, you can choose to make the attack with disadvantage. If the attack hits, you deal an additional amount of damage equal to the weapon's base damage, (2d12 becomes 4d12, 3d6 becomes 6d6, etc). If this attack results in a critical hit, this extra damage is not multiplied when determining the damage for the attack.

<div id="New-Feats-Cloud-Walk">
...
* Once per rest, as an action, you gain the benefits of the *water walk* spell for one hour, and can also walk on the surface of any heavily obscured area. You do not immediately rise when using this ability.
* The first 5 feet of difficult terrain you enter on your turn does not cost extra movement.

<div id="New-Feats-Daylight-Adaption">
...
<div id="New-Feats-Deft-Precision">
...
<div id="New-Feats-Firearm-Mastery">
...
* The *find familiar* spell no longer requires costly material components and the casting time is reduced to 10 minutes.
...
* Once per day, you can increase your size as per the *enlarge/reduce* spell for one minute; your reach increases by 5 feet while enlarged.
* You count as one size category larger for grappling, shoving, and lifting/carrying capacity.

<div id="New-Feats-Natures-Boon">

### Nature's Boon

</div>

A God or Goddess of nature has granted you their boon, you gain the following benefits:

* You can regain all of your hit points in a short rest instead of a long rest.
* You increase your hit points by two per level.
* You increase your movement speed by 10ft.

<div id="New-Feats-Fenris-Scent">

### Scent Of the Fenris

</div>

You feel and scent like wolves, gaining the following benefits:

* Increase your Wisdom score by 1, to a maximum of 20.
* You can trace the smell of blood within 60 ft. of you. You can also smell invisible or hidden creatures.
* Once per long rest, you can identify a creature's type by the scent of its blood

<div id="New-Feats-Spelldriver">
...
* You can attack with weapons with the two-handed property, but not the buster property, using only one hand.
...
<div id="New-Feats-Versatile-Combat">
...
You scream for war. War Cry can be used once per short rest. You and your allies within 60 ft. who can hear you in the battlefield gains following benefits:

* You and your allies have advantage to your melee and ranged weapon attack rolls for 1 minute.
* You and your allies deal +1 more damage with your melee and ranged weapon attacks.

<div id="New-Feats-Old-Races">

## New Racial Feats for Old Races

</div>

<div id="New-Feats-Goliath-1">
...
* Goliaths who can see your skin pattern are subconsciously affected by it. You gain Advantage on all Charisma-based skill checks when dealing with other goliaths. In addition, you have Advantage on Death Saves.
* You gain one of the following ***Markings***. You may change this once per Long Rest. At 11<sup>th</sup> level, you gain a second ***Marking***, and may change it at the same time.
* ***Markings Of The Blessed.*** Your skin markings shift into a pattern that resists a wide array of harmful effects in times of trouble. Once per Short Rest, You have Advantage on one Saving Throw of your choice.
* ***Markings Of The Hunter.*** Your skin markings shift into a pattern that makes you hard to get the drop on. Once per Short Rest, You have Advantage on one Initiative check of your choice.
* ***Markings Of The Magi.*** Your skin markings shift into a pattern  that denotes you as having strong magical talent. Once per Short Rest, You have Advantage on one Spell Attack Roll of your choice.
* ***Markings Of The Warrior.*** Your skin markings have shifted over time into a pattern that gives you fate’s deathly accuracy in times of trouble. Once per Short Rest, You have Advantage on one Weapon Attack Roll of your choice.

<div id="New-Feats-Kenku">
...
- You have advantage on Wisdom (Perception) checks made to locate shiny objects such as coins, gems, or metal. In addition, you have advantage on Wisdom (Perception) checks made to locate the dead.
- Your claws are natural weapons, which you can use to make unarmed strikes. Your claws gain the finesse property, and have a damage die of 1d4.
- Your feathers are natural weapons, with the properties of a dart. In addition, you may use them as lockpicks.
- You flap your wings while falling to slow your descent. You can fall from a height equal to 10 plus 5 times your level in feet without taking damage. When you fall from a height higher than this, you treat the height you have fallen as the difference between the height you fell from and your calculated safe height for the purpose of falling damage.

<div id="New-Feats-Dragonborn">
...
- You have resistance to fire damage when you are in a hot climate, and resistance to cold damage when you are in a cold climate. While in a temperate climate, you may choose which resistance you have when you finish a long rest.

<div id="New-Feats-Aasimar">
...
You gain one more use of your subrace trait Radiant Soul, Radiant Consumption, or Necrotic Shroud, before regaining them on a long rest.

When you are knocked unconscious during the use of Radiant Soul, Radiant Consumption, or Necrotic Shroud, you deal retributive damage to your attacker equal to your level. This damage is radiant or necrotic, depending on your subrace.

<div id="New-Feats-Tabaxi">
...
- The damage of your claws changes from 1d4 to 1d6 and gains the finesse property.
- When you fail a death saving throw, you instead succeed. You may only do so once per long rest.

<div id="New-Feats-Firbolg">
...
- You are under the constant effect of the barkskin spell, unless your shape changes, such as via wildshape.
- After finishing a long rest, 1d4+1 Goodberry's sprout from your skin.
- You learn the druidcraft cantrip.

<div id="New-Feats-Human">
...
You gain a benefit based on your heritage:

- ***Cloud***. Your hit point maximum increases by an amount equal to your level. Whenever you gain a level thereafter, your hit point maximum increases by an additional hit point. You have resistance to thunder damage.
- ***Fire***. You are proficient in one tool of your choice. You can cast burning hands as a 1st level spell once per long rest. You have resistance to fire damage.
- ***Frost***. You gain a swim speed of 30 feet. You are proficient in Survival checks. You have resistance to cold damage.
- ***Hill***. You have advantage on saving throws against poison. You have resistance to acid damage and poison damage.
- ***Stone***. Your fists are natural weapons, capable of dealing 1d6 plus your Strength modifier in bludgeoning damage. You gain one extra use of your Goliath trait, Stones Endurance.
- ***Storm***. Your speed increases by 5 feet. You can breathe air and water. You have resistance to lightning damage.

<div id="New-Feats-Triton">
...
- You have darkvision. Born in the ocean, your vision can easily cut through darkness. You can see in dim light within 60 feet of you as if it were bright light, and in darkness as if it were dim light. You can't discern color in darkness, only shades of gray.
- You have resistance to poison damage.
- When you dash while swimming, you may use a bonus action to dash again.

<div class='pageNumber auto'></div>

\page

<div id="New-Feats-Half-Orc">
...
- ***Shell Slam***. As a reaction to an enemy ending its turn within 5ft of you, you may attempt to push it 5ft away or knock it prone with a Shove from your shell. You are proficient with this Athletics ability check. The target must be no more than one size larger than you.

<div id="New-Feats-Genasi">
...
- You increase your Constitution score by 1, up to a maximum of 20.
- You have advantage on saving throws against poison, and you have resistance against poison damage.

<div id="New-Feats-Warforged-2">
...
You gain 3 points of Resolve, which you regain at the end of a long rest. You can expend resolve to power the following features:

- When you make a Death Saving Thow and fail, you may spend a point of Resolve to ignore it.
- When you would make a Wisdom Saving Throw but before you do so, you may spend a point of Resolve and make a Constitution Saving Throw instead.
- When you make a Constitution Saving Throw but before being told the outcome of your roll, you may spend a point of Resolve and roll one more time. You must take the new roll.
<div id="New-Feats-New-Races">

## Feats for New Races

</div>

New races presented in this document have access to racial feats. Some of these feats are in either [Xanathar's Guide to Everything](https://dnd.wizards.com/products/tabletop-games/rpg-products/xanathars-guide-everything) or [UA Feats for Races](https://media.wizards.com/2017/dnd/downloads/RJSJC2017_04UASkillFeats_24v10.pdf), and are re-flavored feats from other races. Some of these new feats are presented in the following pages. If the feat appears in a published book outside of UA Feats for Races, then the most recent version is to be used.

<div id="New-Feats-Cait-Sith">
...
<div id="New-Feats-Vryloka">

### Vryloka

</div>

Vryloka have access to any Human, Elf or Half-elf racial feats.

<div class='pageNumber auto'></div>

\page

# Chapter 8 &ndash; APPENDICES

<div class='classTable wide' id="Renown-Ref-Table" style="column-count:3;margin-top:3mm;">

| **Renown** | **Harpers** | **Order of the Gauntlet** |
|:--|:--|:--|
| &emsp;1 | &emsp;Watcher | &emsp;Chevall |
| &emsp;3 | &emsp;Harpshadow | &emsp;Marcheon |
| &emsp;10 | &emsp;Brightcandle | &emsp;Whitehawk |
| &emsp;25 | &emsp;Wise Owl | &emsp;Vindicator |
| &emsp;50 | &emsp;High Harper | &emsp;Righteous Hand |

| **Renown** | **Emerald Enclave** | **Lord's Alliance** |
|:--|:--|:--|
| &emsp;1 | &emsp;Springwarden | &emsp;Cloak |
| &emsp;3 | &emsp;Summerstrider | &emsp;Redknife |
| &emsp;10 | &emsp;Autumnreaver | &emsp;Stingblade |
| &emsp;25 | &emsp;Winterstalker | &emsp;Warduke |
| &emsp;50 | &emsp;Master of</br>&emsp;the Wild | &emsp;Lioncrown |

| **Renown** | **Zhentarim** | **Adventurer's League** |
|:--|:--|:--|
| &emsp;1 | &emsp;Fang | &emsp;Auxiliary |
| &emsp;3 | &emsp;Wolf | &emsp;Quaestor |
| &emsp;10 | &emsp;Viper | &emsp;Praefect |
| &emsp;25 | &emsp;Ardragon | &emsp;Tribune |
| &emsp;50 | &emsp;Dread Lord | &emsp;Legate |

</div>

</br>

<div id="Appx-A" style="margin-top:-4mm;">

## APPENDIX A: DMG Rules

</div>

<div id="Appx-A-Renown">
...
For example, members of the Emerald Enclave &ndash; a faction dedicated to preserving the natural order &ndash; might be less friendly toward characters who have not cultivated at least 3 renown within that organization, becoming friendly by default only when a character has gained 10 renown within the Emerald Enclave.

These thresholds apply only to the default attitude of most members of an organization, and such attitudes aren't automatic. NPC faction members might dislike an adventurer despite that character's renown &ndash; or perhaps because of it.

```
```

<div id="Appx-A-Renown-Perks">

### Perks

</div>

Earning a rank within an organization comes with certain benefits, as defined by you. A character of low rank might gain access to a reliable contact and adventure leads, a safe house, or a trader willing to offer a discount on adventuring gear. A middle-ranked character might gain a follower (see chapter 4, &ldquo;Creating Nonplayer Characters&rdquo;, access to potions and scrolls, the ability to call in a favor, or backup on dangerous missions. A high-ranking character might be able to call on a small army, take custody of a rare magic item, gain access to a helpful spellcaster, or assign special missions to members of lower rank.

<div id="Appx-A-Renown-Downtime-Activities">

### Downtime Activities

</div>

You might allow characters to spend downtime between adventures building relationships and gaining renown within an organization. For more information on downtime activities, see chapter 6, &ldquo;Between Adventures.&rdquo;

<div id="Appx-A-Losing-Renown">
...
<div id="Appx-B-Arrow-Detect">

### Arrow of Detection

</div>

Up to seven times per week, you can use an action to toss the arrow into the air and name a creature, object, or place. This can be as specific as &ldquo;the goblin king Guk-luk&rdquo; or as general as &ldquo;the nearest tavern&rdquo;. The arrow briefly hovers in the air, pointing toward the target, then returns to your hand.

<div id="Appx-B-Elven-Boots">
...
## APPENDIX C: Additional Campaign Sources in Use
...
|:--|:--|
| ***Fighter*** | ***Fighter*** |
| [Commander](https://drive.google.com/file/d/1sqxAea_iJ29AOue56Jl6eRWo82Kj6hcJ/view) | [Storm Heart](https://drive.google.com/file/d/1OyMw3uxdkWJmlzeUYz04sMTUZBvyIcbb/view) |
| ***Monk***| ***Paladin***|
| [Way of the Dumpling](https://drive.google.com/file/d/1mMOTkC1jraD1ihO5Y9u3qwsBsDdB7P4L/view) | [Oath of Zeal](https://drive.google.com/file/d/1v-WMFBfzg-oxx8oosKNS8qgF0Lqj8j83/view) |
| ***Feats*** | ***Feats*** |
| [Aditional Feats](https://drive.google.com/file/d/1DkGWc3E6jkhs8dGieishdFrx1SoSGHeY/view) | [13 Additional Feats](https://drive.google.com/file/d/0B40nce9YZ1MbTDJsVjh0ZFpXenc/view) |
...
<div class='classTable wide' id="UA-PS-House-Rules-Table" style="column-count:2;margin-top:2mm;">

### UA House Rules in Use

| **Resource** | **In Use** | **Exceptions** |
|:--|:--|:--|
| &emsp;*Races and Subraces* | &emsp;All<sup>1</sup> | &emsp;&mdash; |
| &emsp;*Classes* | &emsp;none | &emsp;&mdash; |
| &emsp;*Subclasses* | &emsp;See your DM | &emsp;Wizard (Artificer) |
| &emsp;*Extras* | &emsp;none | &emsp;All Else |

<div style="margin-bottom:20mm;"></div>

### Plane Shift Articles House Rules in Use

| **Resource** | **In Use** | **Modifications** | **Exceptions** |
|:--|:--|:--|:--|
| &emsp;*All* | &emsp;Races, Feats | &emsp;&mdash; | &emsp;Bestiary |
| &emsp;*Zendikar* | &emsp;&mdash; | &emsp;&mdash; | &emsp;&mdash; |
| &emsp;*Innistrad* | &emsp;Humans<sup>2</sup> | &emsp;&mdash; | &emsp;&mdash; |
| &emsp;*Kaladesh* | &emsp;All Races<sup>3</sup> | &emsp;Aetherborn<sup>4</sup> | &emsp;&mdash; |
| &emsp;*Amonkhet* | &emsp;All Races<sup>3</sup> | &emsp;Naga<sup>5</sup> | &emsp;&mdash; |
| &emsp;*Ixalan* | &emsp;All Races<sup>3</sup> | &emsp;Naga<sup>5</sup> | &emsp;&mdash; |
| &emsp;*Dominaria* | &emsp;Humans<sup>2</sup>, Other Races | &emsp;Naga<sup>5</sup> | &emsp;&mdash; |

</div>

<div id="Appx-D">

## APPENDIX D: UA and Plane Shift Articles with Changes

</div>

Any Unearthed Arcana that was released before March 31<sup>st</sup>, 2019, will be vetoed and disallowed. This is to limit content which has not seen signifcant updates, or has been released in a WotC Source book already.

<div class='smallerRE'>

**1.** Revenant grants Darkvision 60ft, or an extra 30ft if you already have it.
**2.** Humans from *Innistrad* and *Dominaria* replace Humans from the PHB.
**2.** See Exceptions.
...
## APPENDIX E: Changelogs

<div id='changelog-1.0a'>
...
* Rebooted Campaign guide.
* Changed HP Calculations for PCs.
* Revised Revenant Blade Changes.
* Various other changes.
* Reviewed code conversion and edited to fix code errors.
* Removed old or clunky house rules that are no longer in use.
* Prettyfied select tables to align with page size.

<div id='changelog-1.0b'>
...
* Fixed some hold-overs from original campaign guide, that conflicts with the current guide.

<div id='changelog-1.0c'>
...
* Fixed broken links to free Mage Hand Press / Middle FInger of Vecna resources, as they have been removed.
* Added new rules for Firearms.
* Revised Formatting.
* Reduced Page Count.
* Added the world map.

<div id='changelog-1.0d'>

### 08<sup>th</sup> May, 2020
...
* Three new feats.
* Slight change in formatting to allow for a slightly smaller line weight.
* One page reduction.
* Revised Goliath racials.
* Added new source available for players, and the available content from said source.
* Fixed Firearms in use subsection, as it was not linking correctly to resource. Have now placed the link to the resource in several places.

<div id='changelog-1.0e'>
...
* New feats for races in books after the ***Player's Handbook***
* Various updates

</div>

<div id='changelog-1.0f'>

### 06<sup>th</sup> June, 2020
...
* Revised Formatting
* New content (***Colossification*** Spell)
* Map is no split over four pages
...
# Chapter 9 &ndash; World Map and Major Points Of Interest

### North Ferolia Continent
...
***Chapter 0: Of Dreams and Nightmares***
___
Port of departure for the ill-fated last journey of *The Tenacious*.

### South Ferolia Continent
...
***Chapter 0: Of Dreams and Nightmares***
___
Port of origin and arrival of the ill-fated sloop, *The Tenacious*.
...
***Chapter 1: Isle of Illusions ~ Home of the Guardian***
___
The party washed up on ***Illusia*** near here, and was guided by Crowe herself to her refuge here.

<!---

### ??? /*Nova Crystalis, the realm beyond the veil*/

#### &#x1F4A0; ??? /*Demiplane of the Light Crystal*/

##### ???

###### Took part in battle in:
...
# Join your DM ***RJBPrime***, on a quest of adventure,</br>to find the hidden history of his world, ***GAIA***.</br></br> But beware&hellip;</br></br> Not everything is as it seems&hellip;
